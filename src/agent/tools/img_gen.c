...
int img_gen_init(struct tool_registry *reg, struct model *image_llm)
{
	...
	return tool_register(reg, "img_gen",
		...
		"{\"type\":\"object\",\"properties\":{\"prompt\":{\"type\":\"string\"},\"style\":{\"type\":\"string\"},\"size\":{\"type\":\"string\",\"description\":\"Image size: WIDTHxHEIGHT (e.g. 2048x2048, 2k, 3k, or 4k\"},\"reference_image\":{\"type\":\"string\"}}}",
		img_gen_exec, NULL);
}